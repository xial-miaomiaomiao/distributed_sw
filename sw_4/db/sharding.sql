-- 创建分库分表的数据库
CREATE DATABASE IF NOT EXISTS seckill_db0 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
CREATE DATABASE IF NOT EXISTS seckill_db1 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
